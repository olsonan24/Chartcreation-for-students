...
public class QuickChart : Form
{
	...
	private void panel_MouseMove(object sender, MouseEventArgs e)
	{
		...
		if (isMoving)
		{
			...
			updateScroll(num);
			oldM = newM;
			vScrollBar1.Value = -curr;
		}
	}

	public void updateScroll(int diff)
	{
		if (curr + diff > max)
		{
			diff += max - (curr + diff);
		}
		else if (curr + diff < min)
		{
			diff += min - (curr + diff);
		}
		curr += diff;
		...
		{
			control.Location = new Point(control.Location.X, control.Location.Y + diff);
		}
		StartDrawing();
	}
	...
	{
		Text = "QuickChart for " + _report.FullName + " - Pass 3";
		name = _report.FullName;
		int num = 0;
		int num2 = 0;
		...
		fullName_txt.Text = name.Replace("&", "&&");
	...
	public void setMonth(int offset)
	{
		year1_txt.Text = (DateTime.Now.Year - 1 - offset).ToString();
		year2_txt.Text = (DateTime.Now.Year - offset).ToString();
		year3_txt.Text = (DateTime.Now.Year + 1 - offset).ToString();
	}
	...
	public void setYear(int year)
	{
		...
		int num2 = 0;
		num2 = year;
		age1_txt.Text = Numerology.SpaceOutString(age1.Substring(num2, num), skipSpace: false);
		age10_txt.Text = Numerology.SpaceOutString(age10.Substring(num2, num), skipSpace: false);
		string text = Numerology.SpaceOutString((num2 == 0) ? new string(':', num - 1) : new string(':', num), skipSpace: false);
		nameSep_txt.Text = text;
	}

	public void setYearBig(int year)
	{
		int num = 20;
		int num2 = 0;
		num2 = year;
		age10_big_txt.Text = Numerology.SpaceOutString(age1.Substring(num2, num), skipSpace: false, 2);
		age1_big_txt.Text = Numerology.SpaceOutString(age10.Substring(num2, num), skipSpace: false, 2);
		if (num2 != 0)
		{
			new string(':', num);
		}
	...
	{
		setMonth(_report.Age - trackBar2.Value);
	}
	...
	{
		updateScroll(-vScrollBar1.Value - curr);
		curr = -vScrollBar1.Value;
	}
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pass.Forms.QuickChart));
		...
		this.trackBar1.Location = new System.Drawing.Point(0, 683);
		this.trackBar1.Maximum = 2950;
		...
		this.panel.Size = new System.Drawing.Size(766, 601);
		this.panel.TabIndex = 36;
		this.vScrollBar1.Dock = System.Windows.Forms.DockStyle.Right;
		this.vScrollBar1.LargeChange = 250;
		this.vScrollBar1.Location = new System.Drawing.Point(745, 0);
		...
		this.pym3_txt.Location = new System.Drawing.Point(461, 607);
		this.pym3_txt.Name = "pym3_txt";
		this.pym3_txt.Size = new System.Drawing.Size(168, 15);
		this.pym3_txt.TabIndex = 53;
		...
		this.pm3_txt.Location = new System.Drawing.Point(461, 577);
		this.pm3_txt.Name = "pm3_txt";
		this.pm3_txt.Size = new System.Drawing.Size(168, 15);
		this.pm3_txt.TabIndex = 51;
		...
		this.mcom3_txt.Location = new System.Drawing.Point(461, 562);
		this.mcom3_txt.Name = "mcom3_txt";
		this.mcom3_txt.Size = new System.Drawing.Size(168, 15);
		this.mcom3_txt.TabIndex = 50;
		...
		this.pme3_txt.Location = new System.Drawing.Point(461, 547);
		this.pme3_txt.Name = "pme3_txt";
		this.pme3_txt.Size = new System.Drawing.Size(168, 15);
		this.pme3_txt.TabIndex = 49;
		...
		this.essm3_txt.Location = new System.Drawing.Point(461, 532);
		this.essm3_txt.Name = "essm3_txt";
		this.essm3_txt.Size = new System.Drawing.Size(168, 15);
		this.essm3_txt.TabIndex = 48;
		...
		this.pym1_txt.Location = new System.Drawing.Point(110, 607);
		this.pym1_txt.Name = "pym1_txt";
		this.pym1_txt.Size = new System.Drawing.Size(168, 15);
		this.pym1_txt.TabIndex = 41;
		...
		this.pm1_txt.Location = new System.Drawing.Point(110, 577);
		this.pm1_txt.Name = "pm1_txt";
		this.pm1_txt.Size = new System.Drawing.Size(168, 15);
		this.pm1_txt.TabIndex = 39;
		...
		this.mcom1_txt.Location = new System.Drawing.Point(110, 562);
		this.mcom1_txt.Name = "mcom1_txt";
		this.mcom1_txt.Size = new System.Drawing.Size(168, 15);
		this.mcom1_txt.TabIndex = 38;
		...
		this.pme1_txt.Location = new System.Drawing.Point(110, 547);
		this.pme1_txt.Name = "pme1_txt";
		this.pme1_txt.Size = new System.Drawing.Size(168, 15);
		this.pme1_txt.TabIndex = 37;
		...
		this.essm1_txt.Location = new System.Drawing.Point(110, 532);
		this.essm1_txt.Name = "essm1_txt";
		this.essm1_txt.Size = new System.Drawing.Size(168, 15);
		this.essm1_txt.TabIndex = 36;
		this.essm1_txt.Text = "J F M A M J J A S O N D";
		this.trackBar2.LargeChange = 1;
		this.trackBar2.Location = new System.Drawing.Point(0, 645);
		...
		this.button1.Location = new System.Drawing.Point(301, 717);
		...
		this.button2.Location = new System.Drawing.Point(382, 717);
		...
		this.trackBar3.Location = new System.Drawing.Point(0, 604);
		this.trackBar3.Maximum = 2980;
		this.trackBar3.Minimum = 1;
		this.trackBar3.Name = "trackBar3";
		this.trackBar3.Size = new System.Drawing.Size(744, 45);
		...
		base.ClientSize = new System.Drawing.Size(766, 750);
		...
		base.Name = "pass_quickchart";
		this.Text = "QuickChart - Pass 3";
